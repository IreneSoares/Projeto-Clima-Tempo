...
#cursor.execute ( "INSERT INTO tipos_alerta (id_tipoAlerta, cor) VALUES (1, 'verde')" )
#cursor.execute ( "INSERT INTO tipos_alerta (id_tipoAlerta, cor) VALUES (2, 'amarelo')" )
#cursor.execute ( "INSERT INTO tipos_alerta (id_tipoAlerta, cor) VALUES (3, 'vermelho')" )

#Inserindo periodo
#cursor.execute ( "INSERIR NO PERÍODO (id_periodo, id_contato, diaSemana, horario) VALUES (padrão, 1, 'Segunda-feira', '1:00 às 13:00')" )
#cursor.execute ( "INSERT IN periodo (id_periodo, id_contato, diaSemana, horario) VALUES (padrão, 2, 'Terça-feira', '8:00 às 19:00')" )
#cursor.execute ( "INSERIR NO PERÍODO (id_periodo, id_contato, diaSemana, horario) VALUES (padrão, 3, 'Quarta-feira', '6:00 às 17:00')" )
#cursor.execute ( "INSERIR NO PERÍODO (id_periodo, id_contato, diaSemana, horario) VALUES (padrão, 4, 'Quinta-feira', '8:00 às 20:00')" )
#cursor.execute ( "INSERT IN periodo (id_periodo, id_contato, diaSemana, horario) VALUES (padrão, 5, 'Domingo', '19:00 às 5:00')" )

#Inserindo alerta
#cursor.execute ( "INSERT INTO envio_alerta (id_envioAlerta, id_contato, id_localidade, id_tipoAlerta, id_periodo) VALORES (padrão, 1,1,3,1)" )
#cursor.execute ( "INSERT INTO envio_alerta (id_envioAlerta, id_contato, id_localidade, id_tipoAlerta, id_periodo) VALORES (padrão, 2,2,1,2)" )
#cursor.execute ( "INSERT INTO envio_alerta (id_envioAlerta, id_contato, id_localidade, id_tipoAlerta, id_periodo) VALORES (padrão, 3,3,2,3)" )